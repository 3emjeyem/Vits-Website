...
<body>
    <div class="container">
        ...
        <div class="right">
            ...
            <?php if($errors->has('login')): ?>
                <div class="notification error"><?php echo e($errors->first('login')); ?></div>
            <?php endif; ?>
            <button id="visibleLoginBtn" class="action-btn">SUBMIT</button>
            <div class="create-account">
                <p>Create account? <a href="<?php echo e(url('/signin')); ?>">Sign Up</a></p>
            </div>
        </div>
    </div>
    ...
    <div class="bottom-links">
        <div class="admin-link" style="margin-right:1rem;">
            <p style="margin:0;">Admin? <a href="<?php echo e(url('/admin-login')); ?>">Login as admin</a></p>
        </div>
...
</html><?php /**PATH C:\Users\javin\Codes\vits_website\resources\views/login.blade.php ENDPATH**/ ?>