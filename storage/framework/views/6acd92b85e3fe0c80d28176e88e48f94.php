    ...
    <div class="container">
        ...
        <div class="right">
            ...
            <?php if($errors->has('admin')): ?>
                <div class="notification error"><?php echo e($errors->first('admin')); ?></div>
            <?php endif; ?>

            <button id="visibleAdminLoginBtn" class="action-btn">LOGIN AS ADMIN</button>

            <div class="create-account">
                <p>Back to <a href="<?php echo e(url('/login')); ?>">User Login</a></p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\javin\Codes\vits_website\resources\views/admin-login.blade.php ENDPATH**/ ?>